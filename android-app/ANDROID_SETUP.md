...
│   ├── WebSearchComponent.js # بحث الإنترنت
│   └── ProjectBuilder.js   # منشئ المشاريع
├── utils/                # أدوات مساعدة
│   ├── conversationManager.js # إدارة المحادثات
│   └── imageManager.js     # إدارة الصور والوسائط
